// Central branding so the company identity lives in one place.
// The logo is served from the public Supabase `branding` bucket.
export const COMPANY_NAME = 'Ansaf Electronic';
